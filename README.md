...
## CakePHP ##
Special support to the cake PHP is included. You can access the code, installation and usage information [in the `cake_plugin/CloudinaryCake/README.txt` file](https://github.com/cloudinary/cloudinary_php/tree/master/cake_plugin/CloudinaryCake)
